    ...
    <form id="formUsuario">
      <Stack spacing={6} className="!flex !flex-col !gap-10">
        ...
        <Box>
          ...
          {/* <Field.Root className="!w-1/2">
            <Field.Label>Foto de Perfil</Field.Label>
            {watch("fotoPerfil") && (
              <Box mb={2}>
                <img
                  src={
                    typeof watch("fotoPerfil") === "string"
                      ? `http://localhost:5000/uploads/${watch("fotoPerfil")}`
                      : URL.createObjectURL(watch("fotoPerfil"))
                  }
                  alt="Foto de perfil"
                  style={{
                    width: "100px",
            ...
            <Input
              ...
              accept="image/*"
              onChange={(e) => {
                setValue("fotoPerfil", e.target.files[0]);
              }}
            />
          </Field.Root> */}
              ...
              {watch("fotoPerfil") ? (
                ...
                >
                  ...
                  <Icon
                    ...
                    p="1"
                    cursor="pointer"
                    onClick={() => setValue("fotoPerfil", null)}
                    _hover={{ bg: "red.500" }}
                  />
                </Box>
              ) : (
                ...
                >
                  <FileUpload.HiddenInput
                    onChange={(e) => {
                      ...
                      if (file) setValue("fotoPerfil", file);
                    }}
                  />
                  <FileUpload.Dropzone>
